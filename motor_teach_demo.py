...
def test():
    robot_ctr = Robot(port='COM5')
    # robot_ctr.motorJ[5].speed_control(1, 1, 1)
    time.sleep(2)
    robot_ctr.motorJ[5].set_zeropoint()
    robot_ctr.SetRunJoint(motor_id=6, speed=0.51, pos=3.14)
    time.sleep(5)
    robot_ctr.motorJ[5].position_control_csp(1,3.14)
    # robot_ctr.motorJ[5].position_control(10, 10, 6.28)
    time.sleep(5)
    robot_ctr.DeinitRobot()
